...
# Contributing to robostux.github.io

This is a minimal GitHub Pages redirect page (`index.html`) that forwards visitors from `robostux.github.io` to [github.com/RoboStux](https://github.com/RoboStux). This document is for anyone working on the redirect page itself.
